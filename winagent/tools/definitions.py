...
TOOLS: list[ToolSpec] = [
    ...
    ToolSpec(
        ...
        description=(
            ...
            "IMPORTANT: DO NOT use this to navigate menus. Moving the mouse closes sub-menus. Use keyboard arrow keys!"
        ),
    ...
    ToolSpec(
        ...
        description=(
            ...
            "IMPORTANT: DO NOT use this tool to click on menus, dropdowns, or sub-menus. Use the keyboard keys (arrows and enter) instead!"
        ),
        parameters=_obj({
            **_XY,
